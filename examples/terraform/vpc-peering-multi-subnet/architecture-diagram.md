...
subgraph all_AWS["AWS"]
  subgraph vpc_aws_vpc_peer["VPC peer"]
    tf_aws_vpc_peer["aws_vpc.peer"]
    subgraph subnet_aws_subnet_peer_private["Subnet peer private (Private)"]
    ...
    subgraph subnet_aws_subnet_peer_public["Subnet peer public (Public)"]
  ...
  subgraph vpc_aws_vpc_primary["VPC primary"]
    ...
    subgraph subnet_aws_subnet_primary_private["Subnet primary private (Private)"]
    ...
    subgraph subnet_aws_subnet_primary_public["Subnet primary public (Public)"]
